...
<div class="card-body ">
    <div class="row">
        <div class="col-6">
		    ...
		    @endif
            <h3><i class="fas fa-users mr-2"></i>DATA Level</h3><hr>
        </div>
        <div class="col-6">	
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus-square mr-3"></i>TAMBAH DATA Level</button>
                <!-- Modal -->
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Data Level</h5>
                        ...
                        <div class="modal-body">
				            <form action="{{route('level.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input   name="nama_level" type="text" class="form-control" id="nama_level" aria-describedby="emailHelp" placeholder="nama level" require="">
                                </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <div class="card-panel green white-text">Hasil pencarian : <b>{{$query}}</b></div>
				...
				<tr>
                    <td>{{$image->id}}</td>
                    <td>{{$image->nama_level}}</td>
					<td>
                        
                        <a href="{{ action('LevelController@edit',['id'=>$image->id]) }}" title="Detail" class=" modalMd" data-target="#modalMd" data-toggle="modal"><i class=" fas fa-edit btn btn-warning text-white "></i></a>
                        <a  href="/level/{{ $image->id }}/delete" ><i class="fas fa-trash-alt btn btn-danger text-with" data-toggle="tooltip" title="Hapus"></i></a>
                    </td>
				</tr>
				@endforeach
                {{ $hasil->render() }}
